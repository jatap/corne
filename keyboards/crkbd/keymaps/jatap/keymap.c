...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUMR] = LAYOUT_wrapper(
          _____________________NUMR_L1______________________,      _____________________NUMR_R1______________________,
          _____________________NUMR_L2______________________,      _____________________NUMR_R2______________________,
          _____________________NUMR_L3______________________,      _____________________NUMR_R3______________________,
